import { View, Text, StyleSheet, TouchableOpacity, Animated, KeyboardAvoidingView, Platform, TextInput, Dimensions, Modal } from 'react-native'
...
const Recharge = ({ navigation }) => {
    ...
    return (
        <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} enabled={false} style={styles.screen}>
            <Header />
